...
| Aspecto | `ecf_recibidos` | `aprobaciones_comerciales` |
|---|---|---|
...
> Esquema de las tablas: `db/migrations/deprecated/002_add_ecf_reception.sql`
> (creación), `009_add_aprobacion_comercial_tracking.sql` (columnas salientes) y
> `010_add_ambiente_recepcion.sql` (columna `ambiente`). Ver también
